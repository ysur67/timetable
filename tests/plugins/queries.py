...
@pytest.fixture()
def get_lessons_query(session: AsyncSession, alchemy_to_domain_mapper: AlchemyToDomainMapper) -> GetLessonsQuery:
    return AlchemyGetLessonsQuery(session, alchemy_to_domain_mapper)
